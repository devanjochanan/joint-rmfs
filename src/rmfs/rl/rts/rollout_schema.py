...
def build_decision_event(
    *,
    ...
    feature_ablation_specification: Mapping[str, Any] | None = None,
    ...
    return _json_safe(
        {
            ...
            "feature_ablation_hash": feature_ablation_hash,
            "feature_ablation_specification": dict(feature_ablation_specification or {}),
