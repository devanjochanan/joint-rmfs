...
class RTSRolloutRuntime:
    ...
    def on_decision(self, *, robot: Any, context: Any, decision: Any) -> str | None:
        ...
        row = build_decision_event(
            ...
            feature_ablation=metadata.get("feature_ablation"),
            feature_ablation_hash=metadata.get("feature_ablation_hash"),
            feature_ablation_specification=metadata.get("feature_ablation_specification"),
