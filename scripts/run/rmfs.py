...
def check_specs(fast: bool, skip_compileall: bool) -> list[tuple[str, list[str], Path | None]]:
    ...
    script_checks = [
        ...
        ("rts_branch_execution_smoke", "scripts/validation/rts_branch_execution_smoke.py"),
        ("rts_committed_next_smoke", "scripts/validation/rts_committed_next_smoke.py"),
        ("rts_state_semantics_smoke", "scripts/validation/rts_state_semantics_smoke.py"),
        ("rts_action_alignment_smoke", "scripts/validation/rts_action_alignment_smoke.py"),
        ("rts_cycle_estimator_smoke", "scripts/validation/rts_cycle_estimator_smoke.py"),
