...
def check_specs(fast: bool, skip_compileall: bool) -> list[tuple[str, list[str], Path | None]]:
    ...
    script_checks = [
        ...
        ("detail_db_smoke", "scripts/validation/detail_db_smoke.py"),
        ("pps_observation_contract_smoke", "scripts/validation/pps_observation_contract_smoke.py"),
        ("netlogo_import_contract_smoke", "scripts/validation/netlogo_import_contract_smoke.py"),
        ("order_generation_policy_smoke", "scripts/validation/order_generation_policy_smoke.py"),
        ("local_executor_contract_smoke", "scripts/validation/local_executor_contract_smoke.py"),
