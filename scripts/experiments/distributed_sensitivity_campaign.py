...
# 10,000.00 seconds is not exactly representable with tick_to_second=0.15.
# Use the nearest horizon above 10k: 66,667 backend steps = 10,000.05 s.
SIMULATED_SECONDS = 10_000.05
BACKEND_STEPS_PER_RUN = 66_667
