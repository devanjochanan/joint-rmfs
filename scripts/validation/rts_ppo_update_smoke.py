#!/usr/bin/env python3
"""Pure smoke for the RTS PPO update core."""
...
def synthetic_state(offset: float = 0.0) -> dict:
    return {
        ...
        "zone_rows": [
            {
                ...
                "neighbor_zone_destination_robot_pressure": 0.0,
                "superzone_destination_robot_pressure": 0.0,
        ...
        "stock_rows": [
            {
                "sku_id": "sku-1",
                "local_current_qty": 2.0,
                "local_limit_qty": 10.0,
                "local_fill_ratio": 0.2,
                "local_shortage_depth": 0.1,
                "local_below_threshold": 1.0,
                "local_zero_qty": 0.0,
                "global_fill_ratio": 0.8,
                "global_shortage_depth": 0.0,
                "global_below_threshold": 0.0,
                "local_zero_and_global_low": 0.0,
            }
        ],
        "spatial_context": {
...
def main():
    ...
    assert_raises(lambda: validate_on_policy_training_decision({"actor_kind": "rts_rl_explicit"}), ValueError)
    ...
    validate_on_policy_training_decision(valid_on_policy)
